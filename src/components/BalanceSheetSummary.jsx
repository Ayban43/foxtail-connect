...
const BalanceSheetSummary = ({ balanceSheetFileUrl, onFileUpload , balanceSheetFileAnalysis, onInputValueChange }) => {
    ...
    async function handleRemoveClick() {
        ...
        const { error } = await supabase.storage
            .from('summary_files')
            .remove([balanceSheetFileUrl.replace(supabase.storageUrl + "/object/public/summary_files/", '')]);
    ...
    async function handleFileInputChange(e) {
        ...
        const { data, error } = await supabase.storage
            .from('summary_files')
            .upload("balance_sheet/" + uuidv4(), file, { public: true });
        ...
        <div>
              ...
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                {loading ? (
                  ...
                  <>
                    {balanceSheetFileUrl ? (
                      <>
                        <img className="max-h-52" src={balanceSheetFileUrl} alt="Uploaded File" />
                      </>
                    ) : (
                      <>
                        <svg
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              rows={4}
              value={balanceSheetFileAnalysis}
