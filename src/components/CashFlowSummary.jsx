...
const CashFlowSummary = ({ cashFlowFileUrl, onFileUpload , cashFlowFileAnalysis, onInputValueChange }) => {
              ...
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                {loading ? (
                  ...
                  <>
                    {cashFlowFileUrl ? (
                      <>
                        <img className="max-h-52" src={cashFlowFileUrl} alt="Uploaded File" />
                      </>
                    ) : (
                      <>
                        <svg
