...
const ProfitLossSummary = ({ profitLossFileUrl, onFileUpload , profitLossFileAnalysis, onInputValueChange }) => {
              ...
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                {loading ? (
                  ...
                  <>
                    {profitLossFileUrl ? (
                      <>
                        <img className="max-h-52" src={profitLossFileUrl} alt="Uploaded File" />
                      </>
                    ) : (
                      <>
                        <svg
