                                        ...
                                        return (
                                            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" key={ind}>
                                                ...
                                                <td className="px-6 py-4 flex gap-3">
                                                    <Link to={"../client/checklist/" + info.id}>
                                                        <span className=" cursor-pointer inline-flex items-center text-white w-1/2 px-3 py-2 bg-orange-400 hover:bg-orange-500 hover:cursor-pointer focus:ring-4 focus:ring-blue-200 font-medium rounded-lg text-sm sm:w-auto text-center dark:focus:ring-blue-900">
                                                    ...
                                                    <Link to={"../client/edit/" + info.id}>
                                                        <span className=" cursor-pointer inline-flex items-center text-white w-1/2 px-3 py-2 bg-blue-600 hover:bg-blue-700 hover:cursor-pointer focus:ring-4 focus:ring-blue-200 font-medium rounded-lg text-sm sm:w-auto text-center dark:focus:ring-blue-900">
                                                            <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path><path fillRule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clipRule="evenodd"></path></svg>
                                                            Edit
                                                        </span>
                                                    </Link>
                                                    <span onClick={handleDeleteClick} data-row-id={info.id} className="inline-flex items-center text-white hover:cursor-pointer w-1/2 px-3 py-2 bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-blue-200 font-medium rounded-lg text-sm sm:w-auto text-center dark:focus:ring-blue-900">
