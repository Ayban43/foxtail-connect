                        ...
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-800">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-700">
                                    <button disabled={!logoUrl} className="text-white block w-1/2 px-3 disabled:bg-gray-400 py-2 bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-blue-200 font-medium rounded-lg text-sm sm:w-auto text-center dark:focus:ring-blue-900">Add Client</button>
                                </div>
