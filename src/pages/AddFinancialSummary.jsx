                    ...
                    <div className="relative w-full h-full px-4 md:h-auto">
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-800">
                            ...
                            <div className="flex gap-5 items-center p-6 border-t border-gray-200 rounded-b dark:border-gray-700">
                                ...
                                <button onClick={handleSubmit} className="text-white block w-1/2 px-3 py-2 bg-green-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 font-medium rounded-lg text-sm sm:w-auto text-center dark:focus:ring-blue-900">Publish</button>
                            </div>
                        </div>
                    </div>
                </div>
