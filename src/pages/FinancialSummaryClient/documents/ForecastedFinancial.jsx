...
const ForecastedFinancial = ({ forecastedFinancialUrl, footerLogo, forecastedFinancialAnalysis }) => {
    ...
    useEffect(() => {
        ...
        const fetchPdf = async () => {
            try {
                const response = await fetch(forecastedFinancialUrl);
        ...
        <>
            <Page size="LETTER" style={styles.page}>
                <View style={styles.title}>
                    <Text style={{ borderBottom: '1pt solid black' }}>Forecasted Financials</Text>
                </View>
                <View style={styles.pdfFile}>
                    <Link src={forecastedFinancialUrl}>
                        <Image src={image} />
                    </Link>
                </View>
            ...
            <Page size="LETTER" style={styles.page}>
                ...
                <View style={styles.analysis}>
                    ...
                    <Text style={styles.analysisBody}>{forecastedFinancialAnalysis}</Text>
                </View>
                <View style={styles.footer}>
                    <Image src={footerLogo} style={styles.footerLogoCss} />
                </View>
...
export default ForecastedFinancial;
